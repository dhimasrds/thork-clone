...
class TextWidget<T> (entity: T, context: Context) : AbstractWidget<T> (entity, context) {
    private val TAG = TextWidget::class.java.name
    ...
    override fun create(): LinearLayout {
        fieldName?.let { fieldName ->
            ...
            val editText = createTextWidget(fieldName, widgetValue.toString())
